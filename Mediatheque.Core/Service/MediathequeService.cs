...
namespace Mediatheque.Core.Service
{
    public class MediathequeService
    {
        ...
        public MediathequeService(ApplicationDbContext applicationDbContext, INotationService notationService)
        {
        ...
        public CD AddCd(string album, string groupe)
        {
            ...
            object value = this._applicationDbContext.CDs.Add(cd);
